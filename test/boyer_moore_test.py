...
from boyer_moore import write_to_file, find_pattern_in_text
...
class MyTestCase(unittest.TestCase):
    def test_bm_worst_case(self):
        file = open("../resources/worst_case.txt", 'r')
        text = file.read()
    ...
    def test_bm_best_case(self):
        file = open("../resources/best_case.txt", 'r')
        text = file.read()
    ...
    def test_bm_average_case(self):
        file = open("../resources/avg_case.txt", 'r')
        text = file.read()
